        ...
        >
          ...
          >
            ...
            >
              ...
              <Image
                source={require("../assets/products/denim.png")}
                resizeMode="contain"
                style={{
                  height: "100%",
                  width: "100%",
            ...
            >
              <Text style={{ fontSize: 14 }}>Ksh. 800</Text>
          ...
          >
            ...
            >
              {/* Image with custom placeholder content  */}
              <Image
                source={require("../assets/products/dress.png")}
                resizeMode="contain"
                style={{
                  height: "100%",
                  width: "100%",
      ...
      >
        ...
        >
          ...
          >
            {/* Image with custom placeholder content  */}
            <Image
              source={require("../assets/products/flannel.png")}
              resizeMode="contain"
              style={{
                height: "100%",
                width: "100%",
          ...
          >
            <Text style={{ fontSize: 16 }}>Ksh. 1000</Text>
            <Text style={{ fontWeight: "bold", fontSize: 20 }}>Flannel Shirt</Text>
            <Text>1kg</Text>
          </View>
